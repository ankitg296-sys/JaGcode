...
const DIRECT_RANK_THRESHOLD = 30; // below this, skip pre-filter
const PRE_FILTER_TOP_N = 25;      // how many to pass to LLM ranker
...
/**
 * Score a candidate against a query using TF-IDF-style overlap.
...
/**
 * Pre-filter candidates against a query.
 * Returns top-N most relevant candidates, or all if below threshold.
 */
function preFilter(candidates, query) {
  ...
  // Build IDF map: terms that appear in fewer docs get higher weight
